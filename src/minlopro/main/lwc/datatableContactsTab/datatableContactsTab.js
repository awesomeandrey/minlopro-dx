...
import getContactsCountApex from '@salesforce/apex/DatatableContactsController.getContactsCount';
import getContactsApex from '@salesforce/apex/DatatableContactsController.getContacts';
...
export default class DatatableContactsTab extends LightningElement {
    @track records = [];
    @track draftValues = [];
